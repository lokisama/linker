module.exports = {
  '娱乐、办公从此无国界':'Link the World',
  '快速、简单、安全、便利':'A Magical Door',
  '独创全局智能加速技术，国内外网速优化自动切换。':'To Connect YouTube, Twitter, Google Under the Firewall',
  '登录':'Sign In',
  '注册':'Sign Up',
  '免费体验':'Free',
  '邮箱':'Email',
  ...
  '支付成功':'支付成功',
  '订单会在两分钟内生效，请稍候':'订单会在两分钟内生效，请稍候',
  '系统错误':'系统错误',
  '生成支付订单出错，请稍后再试':'生成支付订单出错，请稍后再试',

  '支付宝扫码支付':'支付宝扫码支付',
  '手机请点击二维码付款':'手机请点击二维码付款',
  'PayPal支付请点击下面按钮':'PayPal支付请点击下面按钮',
  '请选择续费周期：':'请选择续费周期：',
